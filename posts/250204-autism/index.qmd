...
Plot.plot({
  ...
  marks: [
    Plot.rectY(fs, {x: 'year', y: 'count', z: 'case_criterion', interval: 'd3.utcYear', fill: 'case_criterion', order: 'appearance', tip: true}),
    Plot.ruleY([0])
  ]
})
```
...
[^3]: % change is calculated as $(Value_2 - Value_1)/Value_1$