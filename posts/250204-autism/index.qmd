...
Plot.plot({
  ...
  marks: [
    Plot.line(ft, {x: 'year', y: 'prev', stroke: '#1C949D', tip: true}),
    Plot.ruleY([0])
  ]
})
```
...
Plot.plot({
  ...
  marks: [
    Plot.line(ft1, {x: 'year', y: 'prev', stroke: '#1C949D', tip: true}),
    Plot.ruleY([0])
  ]
})
```
...
Plot.plot({
  ...
  marks: [
    Plot.barY(fs, {x: 'year', y: 'count', z: 'case_criterion', interval: 1, fill: 'case_criterion', order: 'appearence', tip: true}),
    Plot.ruleY([0])
  ]
})
```
