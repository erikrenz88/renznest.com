...
usa_trend <- autism |>
    ...
    filter(country == 'USA') |>
    select(year_published, asd_prevalence_estimate_per_1000) |>
    rename(
        year = year_published,
        prev = asd_prevalence_estimate_per_1000
    )
...
study_type <- autism |>
    ...
    rename(
		...
		mutate(
				case_when(
						str_like(case_criterion, '%Dsm-iii%' ~ 'Dsm-iii',
						str_like(case_criterion, '%Dsm-iv%' ~ 'Dsm-iv',
						.default = case_criterion
				)
		)
