...
data_path <- Sys.getenv("DATA_CSV_PATH")

# Debugging: Print the path to confirm
print(paste("Using data path:", data_path))

# Ensure the file exists before reading
if (!file.exists(data_path)) stop("ERROR: data.csv not found!")

# Load the dataset
regs <- read_csv(data_path)
message("Regs read successfully")
```
