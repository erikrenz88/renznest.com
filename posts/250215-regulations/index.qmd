...
# Use `cached_download` to store file temporarily
print("Downloading file to temporary cache...")
file_path = gdown.cached_download(f"https://drive.google.com/uc?id={gdrive_id}")

# Load CSV into DataFrame
df = pd.read_csv(file_path)

# Print DataFrame shape for verification
print(f"Downloaded DataFrame with {df.shape[0]} rows and {df.shape[1]} columns.")

# Save DataFrame to R environment
pandas2ri.activate()
ro.globalenv["regs"] = df
```
