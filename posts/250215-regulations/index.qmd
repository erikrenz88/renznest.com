...
if(!file.exists(here::here('posts/250215-regulations/full_regulations.csv'))) {
    message("ERROR: File missing or empty. Check GitHub Actions logs.")
} else {
    regs <- read_csv(here::here('posts/250215-regulations/full_regulations.csv'))
}
```
