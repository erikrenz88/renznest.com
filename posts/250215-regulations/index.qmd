...
base_path = os.getcwd()  # GitHub Actions' working directory
rules_path = os.path.join(base_path, "posts", "250215-regulations", "federal_register_rule_counts.csv")
doge_path = os.path.join(base_path, "posts", "250215-regulations", "regulation-data.csv")
