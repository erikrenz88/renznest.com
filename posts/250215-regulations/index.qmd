...
# Download file from Google drive if not available
use_python(Sys.which("python3"), required=TRUE)
gdown <- import("gdown")

# File download only if missing
if (!file.exists("data.csv")) {
  gdown$download(id = "1Re-xRy9d3jZmWOVjvC4uwyi8UChxzUIY", output = "data.csv", fuzzy = TRUE, quiet = FALSE)
